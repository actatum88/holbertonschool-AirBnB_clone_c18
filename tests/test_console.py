...
class TestConsoleDocs(unittest.TestCase):
    ...
    def test_format(self):
        ...
        self.assertEqual(hbnb_dict["created_at"], hbnb_console.created_at.strftime(time_format))
        self.assertEqual(hbnb_dict["updated_at"], hbnb_console.updated_at.strftime(time_format))
